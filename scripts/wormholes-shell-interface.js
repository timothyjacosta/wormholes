/* GENERATED from scripts/modules/shell-interface.mjs. Do not edit this direct-file compatibility adapter. */
...
function clearSavedToastPosition() {}

function positionSavedToast() {
  return 0;
}

function queueSavedToastPosition() {}

function normalizeToastMessageForDedupe(message = "") {
...
function reportAppError(context, error, options = {}) {
  const appErrors =
...
function installLegacyShellBindings(target = globalThis) {
