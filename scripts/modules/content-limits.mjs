/* Wormholes Beta 248 string-length and nesting-depth safeguards.
   Keeps pathological fields and deeply nested imports from exhausting memory while preserving older over-limit work. */
