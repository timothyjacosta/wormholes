...
} from "./map-presentation-helpers.mjs";
import {
  populateEditSelects,
...
} from "./app-workflow-orchestration.mjs";
import {
  ...
  openMapListView,
} from "./map-inspector-orchestration.mjs";
...
export function installLegacyAppCoreBindings(target = globalThis) {
  const bindings = {
    makeId,
    compactText,
