/* Wormholes Beta 248 unfinished manual-creation draft storage.
   Keeps small, per-universe form drafts in localStorage so accidental navigation,
   refreshes, and browser restarts do not discard work that has not been archived. */
