/* Wormholes Beta 301 hidden generation-version registry module.
...
export const LEGACY_DIAGNOSTIC_VERSION = 1;
export const ALGORITHM = "xorshift32-v1";
export const SEED_BEHAVIOR_VERSION = "xorshift32-inclusive-int-v1";
export const GENERATOR_VERSION = "beta-297";
export const TABLE_VERSION = "theme-decks-v1";
...
export function normalizeDiagnostic(metadata) {
...
export function compatibility(metadata, currentVersions = {}) {
