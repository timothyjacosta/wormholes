/* Wormholes Beta 262 shared application-error standard.
   Keeps stable error codes and concise recovery guidance separate from technical details. */
...
export class WormholesError extends Error {
...
export function userMessageFor(errorOrCode, fallback = "") {
...
export function actionFor(errorOrCode, fallback = "") {
...
export function toErrorRecord(error, options = {}) {
