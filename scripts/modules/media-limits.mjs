/* Wormholes Beta 248 embedded-media and data-URL safeguards.
   Bounds portable media payloads without reducing normal image-heavy worldbuilding. */
...
import {api as importedFileLimitsApi} from "./file-limits.mjs";
