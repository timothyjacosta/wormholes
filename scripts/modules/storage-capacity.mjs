/* Wormholes Beta 248 browser-storage capacity preflight.
   Uses the browser's origin-wide quota estimate to warn or block before large writes.
   Estimates are deliberately conservative and never replace existing transactional rollback/error handling. */
