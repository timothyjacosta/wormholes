/* Wormholes Beta 248 centralized safe-render helpers.
 *
 * User-authored values should reach HTML only through this module's escaping,
 * safe-markup template, or DOM-construction helpers. Rich Literature HTML has
 * its own allow-list sanitizer and is intentionally kept separate.
 */
