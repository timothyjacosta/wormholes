/* Wormholes Beta 301 transactional persistence coordinator.
   Multi-part saves validate everything first, write large payloads before metadata,
   and update visible runtime state only after every persistence step succeeds. */
...
export function installTransactionalPersistence(target = globalThis) {
